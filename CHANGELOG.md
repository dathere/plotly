...
- [[#XXX](https://github.com/plotly/plotly.rs/pull/XXX)] Add `DensityMap` (MapLibre `map` subplot) trace type — density heatmaps with full color-scale and hover support
